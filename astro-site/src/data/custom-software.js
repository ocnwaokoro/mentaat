export const meta = {
  ...
  ctaHeadHtml: 'Let us find the one thing slowing you down in <em>your operation</em>',
  ctaSub: 'Walk us through where the business strains. We will show you the system that takes the weight off.',
};
export const how = [
  { num: '01', label: 'Diagnose', title: 'We find the real bottleneck', body: 'We get into your business and map the path from quote to getting paid. The constraint is often not where you think it is.' },
  { num: '02', label: 'Build', title: 'Systems made for your operation', body: 'Custom software built around how your business actually runs, not a template you have to bend yourself around.' },
  { num: '03', label: 'Stay', title: 'We stay until it works', body: 'It means we are in it with you, through rollout and the messy edges, until the system carries real weight.' },
];
export const proof = [

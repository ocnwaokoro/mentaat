...
### 2.1 Create Linear Project

Use Linear MCP to create a project:
- **Name:** [Product Name]
- **Description:** First line of PRD Executive Summary

### 2.2 Process PRD into tickets

Invoke `/prd docs/PRD.md` which will:
